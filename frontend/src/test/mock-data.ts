...
export const mockUsers = {
  ...
  returningUser: TestDataGenerator.generateUser({
    trips: [
      { id: 'trip-1', destination: 'Tokyo', status: 'completed' }
    ],
    preferences: {
      language: 'ar',
      currency: 'SAR',
...
export const mockConversations = {
  ...
  anxiousUser: [
    ...
    {
      id: 'msg-2',
      content: 'لا تقلق! السفر لوحدك يمكن أن يكون تجربة رائعة. سأساعدك في كل خطوة.',
      sender: 'assistant',
  ...
  experiencedUser: [
    ...
    {
      id: 'msg-2',
      content: 'أهلاً صديقي! أراك متحمساً لرحلة جديدة. ما نوع الوجهة التي تفكر فيها؟',
      sender: 'assistant',
