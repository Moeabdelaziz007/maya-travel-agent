  ...
  const experiences = [
    {
      ...
      icon: '🏄',
      description: 'Surfing, diving, hiking & more',
    },
    {
      title: 'Cultural Tours',
      icon: '🏛️',
      description: 'Museums, landmarks, heritage sites',
    },
    {
      title: 'Food & Wine',
      icon: '🍷',
      description: 'Culinary experiences & tastings',
    },
    {
      title: 'Wellness & Spa',
      icon: '💆',
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Let Amriyy AI craft your perfect journey with personalized
              recommendations, instant bookings, and unforgettable experiences.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Explore the most popular places our travelers are visiting this
              month
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl mb-8 opacity-90">
              Join millions of travelers who trust Amriyy for their perfect
              journey
            </p>
