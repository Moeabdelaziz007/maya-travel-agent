# OpenMemory Guide - Amrikyy Platform

## Project Overview

**Amrikyy** is an AI Automation Platform that currently features intelligent travel services. The project combines modern web technologies with AI-powered automation and will expand to serve multiple automation domains. Currently features a React-based frontend, Node.js backend, and integrates with multiple services including Telegram Bot, Z.ai (GLM-4.6), Stripe payments, and Supabase database.
...
- 🤖 Conversational AI with Amrikyy persona (friendly, culturally-aware travel assistant)
- 🚀 Quantum AI landing page showcasing future automation capabilities
...
- Landing page at `/` - Quantum AI showcase
- Travel app at `/app` - Full travel assistant functionality
...
- **Brand Evolution**: Positioned as AI Automation Platform (Amrikyy) with travel services as initial offering
...
- **ai**: Z.ai integration, Amrikyy persona configuration, user profiling, conversation management, MCP tools, cultural adaptations
...
- Chat interface with Amrikyy AI
...
- Uses Amrikyy persona and user profiling
...
- Amrikyy persona loaded as system prompt
...
_This section will be populated as debugging sessions occur._
...
_This section will be populated as user preferences are discovered._
