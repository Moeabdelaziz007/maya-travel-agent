/**
 * Maya Travel Agent - Code Recipes and Templates
    ...
    return \`
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee; color: #666;">
          <p>This alert was generated by Maya Travel Agent monitoring system.</p>
...
describe('Maya Travel Agent API', () => {
  let app;
  let testUser;
  let authToken;
  ...
  before(async () => {
    ...
    // Create test user
    testUser = {
      email: \`test_\${Date.now()}@maya-travel.com\`,
